    ...
    <main>
      <div id="details" class="clearfix">
        <div id="client">
          ...
          <h2 class="name"><?php echo $row_user['username'] ?></h2>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="1"></td>
            <td colspan="1">TAX <?php echo $total_discount ?>%</td>
            <td>$<?php echo $sale_cost ?></td>
          </tr>
          <tr>
            <td colspan="1"></td>
            <td colspan="1">GRAND TOTAL</td>
            <td>$<?php echo $total_cost_after_discount ?></td>
          </tr>
        </tfoot>
      </table>
